...
function getBestPostingTimes(category?: string): string {
  ...
  if (niche.includes('dating') || niche.includes('relationship')) {
    return '📅 Best times to post: Tuesday–Thursday, 7–9 PM or Saturday 11 AM–1 PM\n💡 Dating content performs best in evening hours when people are swiping.';
  }
...
const HOOKS = [
  { id: 1, text: "My friend said I'm terrible at texting girls until I showed her this AI app", formula: 0, rating: 0, fav: false },
  { id: 2, text: "My roommate said my Hinge openers were cringe until I started using Wit", formula: 0, rating: 0, fav: false },
  { id: 3, text: "My sister read my Tinder messages and said I need professional help. So I got AI help", formula: 0, rating: 0, fav: false },
  { id: 4, text: "POV: You just discovered an AI that writes your dating app messages", formula: 1, rating: 0, fav: false },
  { id: 5, text: "POV: Your Hinge response rate goes from 10% to 80% overnight", formula: 1, rating: 0, fav: false },
  { id: 6, text: "I used to get ghosted on Hinge. Then I found Wit.", formula: 2, rating: 0, fav: false },
  { id: 7, text: "I sent 'hey' on Bumble for 6 months. Then Wit wrote my messages for me.", formula: 2, rating: 0, fav: false },
  { id: 8, text: "Stop sending 'hey' on dating apps. Do this instead", formula: 3, rating: 0, fav: false },
  { id: 9, text: "Day 7 of using AI to write my Tinder messages — my response rate went from 10% to 80%", formula: 4, rating: 0, fav: false },
  { id: 10, text: "Day 30 of letting AI write my dating app messages — I have 3 dates this week", formula: 4, rating: 0, fav: false },
];
...
// --- Performance Data ---
const PERF_POSTS = [
  { id: 1, title: 'Friend was SHOCKED by my reply rate', views: 234200, likes: 18400, shares: 4200, comments: 890, formula: 'Person + Conflict', date: 'Feb 1' },
  { id: 2, title: 'POV: AI writes your Hinge messages', views: 142000, likes: 11200, shares: 2800, comments: 620, formula: 'POV Discovery', date: 'Feb 3' },
  { id: 3, title: 'Got ghosted on Hinge then found Wit', views: 108000, likes: 8900, shares: 2100, comments: 480, formula: 'Competitor Switch', date: 'Feb 5' },
  { id: 4, title: 'Day 30 using AI for dating texts', views: 9800, likes: 720, shares: 180, comments: 45, formula: 'Day N Journey', date: 'Feb 6' },
  { id: 5, title: 'Stop sending hey on dating apps', views: 8400, likes: 610, shares: 150, comments: 38, formula: 'Stop + Do This', date: 'Feb 7' },
  { id: 6, title: 'My mom read my AI-written texts', views: 7200, likes: 540, shares: 120, comments: 32, formula: 'Person + Conflict', date: 'Feb 8' },
  { id: 7, title: 'Message glow-up before vs after AI', views: 6100, likes: 450, shares: 95, comments: 28, formula: 'Before/After', date: 'Feb 9' },
  { id: 8, title: 'Best AI opening lines for Tinder', views: 5300, likes: 380, shares: 82, comments: 22, formula: 'Tutorial', date: 'Feb 10' },
  { id: 9, title: 'Got a reply in 5 minutes with AI', views: 4800, likes: 340, shares: 70, comments: 18, formula: 'Speed Demo', date: 'Feb 11' },
  { id: 10, title: 'Introvert texting hack with AI', views: 3900, likes: 280, shares: 55, comments: 15, formula: 'Day N Journey', date: 'Feb 12' },
  { id: 11, title: 'My texts before vs after Wit AI', views: 3200, likes: 230, shares: 48, comments: 12, formula: 'Before/After', date: 'Jan 28' },
  { id: 12, title: 'Wit AI vs writing texts yourself', views: 2800, likes: 200, shares: 40, comments: 10, formula: 'Competitor Switch', date: 'Jan 29' },
  { id: 13, title: 'AI conversation starters that work', views: 2100, likes: 150, shares: 32, comments: 8, formula: 'Tutorial', date: 'Jan 30' },
  { id: 14, title: 'Long distance texting with AI help', views: 1800, likes: 130, shares: 25, comments: 6, formula: 'Before/After', date: 'Jan 31' },
  { id: 15, title: 'Wit AI reply suggestions tutorial', views: 1200, likes: 90, shares: 18, comments: 4, formula: 'Tutorial', date: 'Jan 27' },
];
...
export default function TikTokPage() {
  ...
  const [postCaption, setPostCaption] = useState('This AI writes your dating app messages for you 🔥');
  const [postHashtags, setPostHashtags] = useState(['dating', 'witdating', 'relationships', 'love', 'fyp']);
