...
const DEFAULT_WEEKS: Week[] = [
  {
    ...
    steps: [
      { id: '1', title: 'Finalize listing', status: 'done', description: 'Polish app store listing with optimized title, subtitle, and keyword field.', aiContent: 'Title: "Wit Dating — AI Message Assistant"\nSubtitle: "Write better messages on Hinge, Tinder & Bumble"' },
      { id: '2', title: 'Generate ad creative', status: 'done', description: 'Create ad variations for Apple Search Ads, Meta, and TikTok campaigns.', aiContent: 'Ad Set 1 (Apple Search Ads):\nHeadline: "Never Send \'Hey\' Again — AI Writes Your Dating Messages"' },
      { id: '3', title: 'Build landing page', status: 'done', description: 'Create a conversion-optimized landing page.', aiContent: 'Landing page structure:\n1. Hero: "Write Messages That Get Replies" + app mockup\n2. Feature grid\n3. Response rate stats\n4. Testimonials\n5. Download CTA' },
      { id: '4', title: 'Identify influencers', status: 'done', description: 'Find 15-20 micro-influencers in the dating advice/lifestyle niche.', aiContent: 'Top 5 identified:\n1. @datingcoach_jess (TikTok, 85K)\n2. @lovelife_mike (Instagram, 120K)\n3. @textgame_queen (TikTok, 200K)' },
      { id: '5', title: 'Draft community posts', status: 'in-progress', description: 'Write posts for Reddit, Product Hunt, and Indie Hackers.', aiContent: 'Reddit Draft (r/dating_advice):\n"I built an AI assistant that writes your dating app messages — response rates went up 5x"' },
    ],
  },
  {
    label: 'Week -1', key: 'w-1',
    steps: [
      { id: '6', title: 'Send influencer outreach', status: 'in-progress', description: 'Send personalized DMs to identified influencers.', aiContent: 'DM Template:\n"Hey [name]! 👋 Love your content. We\'re building Wit Dating — want early access + lifetime premium?"' },
      { id: '7', title: 'Social teases', status: 'in-progress', description: 'Post teaser content building anticipation.', aiContent: 'Tweet thread:\n1/5: "What if AI could write your dating app messages for you? 🤔"' },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: '20', title: 'Post week 1 update', status: 'queued', description: 'Share week 1 metrics publicly.', aiContent: '"📊 Wit Dating Week 1 Numbers:\n• 2,400 downloads\n• 680 trial starts"' },
    ],
  },
  {
    label: 'Week +2', key: 'w+2',
    steps: [
      { id: '21', title: 'Keyword optimization', status: 'queued', description: 'Analyze keyword rankings and optimize metadata.', aiContent: '📈 Rising: "ai dating assistant" — add to subtitle\n📉 Dropping: "dating app free" — deprioritize' },
      ...
      { id: '23', title: 'Refresh ad copy', status: 'queued', description: 'Create new ad variations based on performance data.', aiContent: 'Variation A: "Write messages so good your matches think you\'re charming"' },
      { id: '24', title: 'Expand keywords', status: 'queued', description: 'Add new keyword opportunities.', aiContent: '1. "ai dating match" — Vol: 4,500, Diff: 28\n2. "smart dating" — Vol: 2,100' },
      { id: '25', title: 'Monitor competitors', status: 'queued', description: 'Track competitor responses to your launch.', aiContent: '🔍 Hinge — No changes\n🔍 Bumble — Updated subtitle' },
    ],
  },
];
...
export default function LaunchPage() {
  ...
  const generateAIContent = useCallback(async (step: Step) => {
    ...
    try {
      ...
      const res = await fetch('/api/ai', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ task: 'generate-launch-content', stepTitle: step.title, stepDescription: step.description, appData }) });
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-neutral-500">{getAppData()?.name || 'Wit Dating'} — 5-week launch plan</p>
          </div>
        </div>
