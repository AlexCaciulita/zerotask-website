...
const KEYWORDS_RAW = [
  { keyword: 'dating app assistant', volume: 74000, difficulty: 45, rank: 2, change: 8, since: '2025-06-01' },
  { keyword: 'ai message writer', volume: 68000, difficulty: 42, rank: 3, change: 6, since: '2025-06-10' },
  { keyword: 'dating conversation helper', volume: 52000, difficulty: 38, rank: 2, change: 9, since: '2025-07-15' },
  { keyword: 'rizz ai', volume: 120000, difficulty: 55, rank: 4, change: 12, since: '2025-08-01' },
  { keyword: 'dating text helper', volume: 45000, difficulty: 35, rank: 1, change: 7, since: '2025-09-20' },
  { keyword: 'ai dating assistant', volume: 85000, difficulty: 50, rank: 3, change: 10, since: '2025-06-01' },
  { keyword: 'hinge message helper', volume: 42000, difficulty: 32, rank: 2, change: 8, since: '2025-10-05' },
  { keyword: 'tinder opener generator', volume: 58000, difficulty: 40, rank: 3, change: 5, since: '2025-08-12' },
  { keyword: 'dating app message writer', volume: 38000, difficulty: 36, rank: 1, change: 11, since: '2025-09-01' },
  { keyword: 'ai wingman app', volume: 31000, difficulty: 30, rank: 2, change: 9, since: '2025-10-12' },
  { keyword: 'what to say on hinge', volume: 95000, difficulty: 62, rank: 5, change: 4, since: '2025-05-20' },
  { keyword: 'dating reply suggestions', volume: 29000, difficulty: 28, rank: 1, change: 6, since: '2025-11-01' },
  { keyword: 'bumble conversation starters', volume: 67000, difficulty: 55, rank: 7, change: 3, since: '2025-07-08' },
  { keyword: 'ai pick up lines', volume: 48000, difficulty: 38, rank: 4, change: 5, since: '2025-08-18' },
  { keyword: 'dating message generator', volume: 35000, difficulty: 33, rank: 2, change: 8, since: '2025-09-15' },
  { keyword: 'how to text on dating apps', volume: 110000, difficulty: 70, rank: 8, change: 2, since: '2025-05-15' },
  { keyword: 'tinder text assistant', volume: 27000, difficulty: 29, rank: 1, change: 7, since: '2025-10-25' },
  { keyword: 'dating icebreakers ai', volume: 33000, difficulty: 31, rank: 2, change: 6, since: '2025-09-10' },
  { keyword: 'response rate dating app', volume: 41000, difficulty: 44, rank: 6, change: 3, since: '2025-08-22' },
  { keyword: 'better dating messages', volume: 56000, difficulty: 48, rank: 5, change: 4, since: '2025-07-20' },
  { keyword: 'ai flirt assistant', volume: 22000, difficulty: 25, rank: 1, change: 9, since: '2025-11-10' },
  { keyword: 'dating coach ai', volume: 39000, difficulty: 37, rank: 3, change: 7, since: '2025-10-02' },
  { keyword: 'wit dating assistant', volume: 18000, difficulty: 15, rank: 1, change: 12, since: '2025-10-25' },
  { keyword: 'smart dating messages', volume: 25000, difficulty: 30, rank: 2, change: 8, since: '2025-09-08' },
  { keyword: 'dating ghosting help', volume: 44000, difficulty: 42, rank: 4, change: 5, since: '2025-08-05' },
  { keyword: 'best dating app helper', volume: 62000, difficulty: 52, rank: 6, change: 3, since: '2025-05-01' },
  { keyword: 'ai dating texting', volume: 37000, difficulty: 34, rank: 2, change: 7, since: '2025-05-10' },
  { keyword: 'hinge conversation tips', volume: 78000, difficulty: 58, rank: 9, change: 1, since: '2025-07-12' },
  { keyword: 'dating message ideas', volume: 50000, difficulty: 46, rank: 5, change: 4, since: '2025-08-28' },
  { keyword: 'ai conversation starter', volume: 46000, difficulty: 40, rank: 3, change: 6, since: '2025-09-22' },
  { keyword: 'text game dating', volume: 34000, difficulty: 36, rank: 4, change: 5, since: '2025-06-15' },
  { keyword: 'dating profile writer ai', volume: 28000, difficulty: 32, rank: 2, change: 8, since: '2025-10-18' },
  { keyword: 'funny openers dating app', volume: 53000, difficulty: 45, rank: 6, change: 3, since: '2025-07-25' },
  { keyword: 'how to not get ghosted', volume: 71000, difficulty: 55, rank: 7, change: 2, since: '2025-08-10' },
  { keyword: 'dating response generator', volume: 20000, difficulty: 22, rank: 1, change: 10, since: '2025-11-20' },
  { keyword: 'ai text suggestions dating', volume: 16000, difficulty: 20, rank: 1, change: 9, since: '2025-10-28' },
  { keyword: 'witty messages for tinder', volume: 43000, difficulty: 39, rank: 3, change: 6, since: '2025-09-28' },
  { keyword: 'dating app rizz helper', volume: 32000, difficulty: 28, rank: 2, change: 11, since: '2025-10-15' },
  { keyword: 'improve dating conversations', volume: 47000, difficulty: 43, rank: 5, change: 4, since: '2025-06-30' },
  { keyword: 'ai message helper dating', volume: 24000, difficulty: 26, rank: 1, change: 8, since: '2025-09-05' },
  { keyword: 'dating chat assistant', volume: 30000, difficulty: 31, rank: 2, change: 7, since: '2025-10-22' },
  { keyword: 'hinge reply ideas', volume: 36000, difficulty: 35, rank: 3, change: 6, since: '2025-08-15' },
  { keyword: 'tinder conversation ai', volume: 40000, difficulty: 38, rank: 4, change: 5, since: '2025-09-18' },
  { keyword: 'dating text generator', volume: 26000, difficulty: 27, rank: 2, change: 9, since: '2025-11-08' },
  { keyword: 'bumble message ideas', volume: 55000, difficulty: 47, rank: 6, change: 3, since: '2025-05-25' },
  { keyword: 'first message dating app ai', volume: 19000, difficulty: 23, rank: 1, change: 10, since: '2025-11-05' },
  { keyword: 'dating wingman ai', volume: 21000, difficulty: 25, rank: 2, change: 8, since: '2025-10-30' },
  { keyword: 'opener generator hinge', volume: 15000, difficulty: 18, rank: 1, change: 11, since: '2025-11-15' },
  { keyword: 'ai dating message coach', volume: 23000, difficulty: 24, rank: 1, change: 9, since: '2025-10-08' },
  { keyword: 'stop getting ghosted app', volume: 38000, difficulty: 40, rank: 4, change: 6, since: '2025-07-30' },
];
    ...
    try {
      const res = await fetch('/api/ai', {
        ...
        body: JSON.stringify({
          ...
          currentTitle: 'Wit Dating — Smart Dating App',
