...
const INFLUENCERS: Influencer[] = [
  { id: '1', name: 'Jessica Chen', initials: 'JC', color: COLORS[0], platform: 'TikTok', followers: '85K', followersNum: 85000, engagement: '4.2%', niche: ['Dating Texting', 'Tutorials'], stage: 'deal', email: 'jess@creator.io', handle: '@creativejess', outreachHistory: ['Jan 15 — Initial DM sent', 'Jan 17 — Responded, interested', 'Jan 20 — Negotiated terms', 'Jan 22 — Deal closed: $200 + lifetime premium'], cashOffer: 200, aiDMs: ['Hey Jessica! 👋 Huge fan of your dating content. We\'re launching Wit Dating, an AI dating message assistant, and think your audience would love it. Want to collab? Free lifetime premium + $200 for a dating challenge video!', 'Hi Jess! Your recent Hinge vs Wit comparison was 🔥. We just built something that takes dating app messaging to a whole new level. Would love to send you early access and see what you think!', 'Jessica — quick pitch: AI dating assistant, AI-powered message suggestions. Your 85K followers are exactly our target audience. Interested in a paid collab? Details below 👇'] },
  { id: '2', name: 'Mike Torres', initials: 'MT', color: COLORS[1], platform: 'Instagram', followers: '120K', followersNum: 120000, engagement: '3.8%', niche: ['Dating Texting', 'Lifestyle'], stage: 'posted', email: 'mike@shotby.co', handle: '@shotbymike', outreachHistory: ['Jan 10 — DM sent', 'Jan 11 — Responded same day', 'Jan 14 — Sent app access', 'Jan 20 — Posted reel, 45K views'], cashOffer: 350, aiDMs: ['Mike! Your dating advice content is insane. We built Wit Dating — AI message writing for modern singles. Would love to send you early access + sponsorship for a reel.', 'Hey Mike, saw your latest gear review. What if the best dating app wasn\'t gear — it was AI? Check out Wit Dating. Happy to sponsor a review post!', 'Hi Mike — launching an AI dating message assistant next week. Your audience = our perfect users. Interested in early access + paid collab?'] },
  { id: '3', name: 'Sarah Kim', initials: 'SK', color: COLORS[2], platform: 'TikTok', followers: '200K', followersNum: 200000, engagement: '5.1%', niche: ['Texting Tips', 'Self-Improvement'], stage: 'posted', email: 'sarah@editqueen.co', handle: '@editqueen', outreachHistory: ['Jan 8 — DM via management', 'Jan 12 — Management responded', 'Jan 15 — Terms agreed', 'Jan 25 — Video posted, 120K views!'], cashOffer: 500, aiDMs: ['Sarah, your dating success content is what inspired us to build Wit Dating. AI-powered message suggestions. Would your audience love a "blind date" challenge video?', 'Hey! Love @editqueen content. We\'re launching an AI dating message assistant — perfect for dating success content. Interested in early access + a sponsored collab?', 'Hi Sarah\'s team — reaching out about Wit Dating, an AI dating message assistant launching on Product Hunt. Sarah\'s before/after style would be perfect. Details attached.'] },
  { id: '4', name: 'Sam Patel', initials: 'SP', color: COLORS[3], platform: 'YouTube', followers: '45K', followersNum: 45000, engagement: '6.2%', niche: ['App Reviews', 'Tech'], stage: 'negotiating', email: 'sam@techreviews.dev', handle: '@samreviews_tech', outreachHistory: ['Jan 18 — Email sent', 'Jan 20 — Replied, wants to try app first'], cashOffer: 150, aiDMs: ['Sam! Big fan of your dating app review videos. We\'re launching Wit Dating — would love to send you early access for an honest review. Also happy to sponsor the video.', 'Hey Sam, your in-depth app reviews are exactly what we need. Wit Dating is an AI dating message assistant launching next week. Free lifetime + sponsorship for a review?', 'Hi Sam — Wit Dating here. AI dating assistant, launching on PH next week. Your review style is perfect for our audience. Interested?'] },
  { id: '5', name: 'Ava Wright', initials: 'AW', color: COLORS[4], platform: 'Instagram', followers: '60K', followersNum: 60000, engagement: '4.8%', niche: ['Relationships', 'Love'], stage: 'contacted', email: 'ava@filterfinds.io', handle: '@filterfinds', outreachHistory: ['Jan 22 — DM sent, no response yet'], cashOffer: 180, aiDMs: ['Ava! Love your dating advice posts. We built Wit Dating with AI message generation that adapts to your preferences. Would love to collab — free premium + sponsorship!', 'Hey Ava, your audience trusts your filter picks. What if we showed them AI message generation that gets smarter? Early access + paid post?', 'Hi Ava — Wit Dating = AI-powered messages that actually understands you. Think your 60K followers would love it. Interested in a collab?'] },
  { id: '6', name: 'David Park', initials: 'DP', color: COLORS[5], platform: 'TikTok', followers: '310K', followersNum: 310000, engagement: '3.5%', niche: ['Texting Hacks', 'Viral'], stage: 'discovered', email: 'david@datinghacks.com', handle: '@davidsdatingtips', outreachHistory: [], cashOffer: 800, aiDMs: ['David! Your dating hack videos are incredibly creative. We\'re launching an AI dating message assistant — imagine a "dating hack" challenge video. Interested?', 'Hey David, 310K followers who love dating tips = dream collab for us. Wit Dating does AI message generation in one tap. Want early access?', 'Hi David — we built Wit Dating (AI dating assistant). Your viral dating hacks + our AI = amazing content potential. Let\'s chat!'] },
  { id: '7', name: 'Luna Martinez', initials: 'LM', color: COLORS[6], platform: 'Instagram', followers: '95K', followersNum: 95000, engagement: '4.5%', niche: ['Dating', 'Lifestyle'], stage: 'responded', email: 'luna@lunamartinez.com', handle: '@lunadates', outreachHistory: ['Jan 19 — DM sent', 'Jan 21 — Responded: "Sounds interesting, tell me more"'], cashOffer: 250, aiDMs: ['Luna! Your dating content is stunning. We built AI-powered message suggestions features for Wit Dating. Would love your take on it + a collab!', 'Hey Luna, imagine one-tap perfect matches. That\'s Wit Dating. Your lifestyle audience would love it. Interested in early access?', 'Hi Luna — reaching out from Wit Dating. AI dating messages that actually sound like you. Your feed is the perfect showcase. Collab?'] },
  { id: '8', name: 'Tyler Brooks', initials: 'TB', color: COLORS[7], platform: 'YouTube', followers: '78K', followersNum: 78000, engagement: '5.8%', niche: ['Texting Tutorials', 'Software'], stage: 'contacted', email: 'tyler@tyleredits.com', handle: '@tyleredits', outreachHistory: ['Jan 21 — Email sent with product info'], cashOffer: 220, aiDMs: ['Tyler! Your dating content are so well-produced. We\'d love to sponsor a "Wit Dating AI vs Manual Editing" video. Thoughts?', 'Hey Tyler, big fan of your workflow videos. What if AI could do 80% of the edit? That\'s Wit Dating. Interested in a sponsored review?', 'Hi Tyler — Wit Dating is an AI dating message assistant perfect for a tutorial video. Sponsorship + lifetime premium. Let me know!'] },
  { id: '9', name: 'Mia Zhang', initials: 'MZ', color: COLORS[8], platform: 'TikTok', followers: '150K', followersNum: 150000, engagement: '6.0%', niche: ['Dating Messages', 'Art'], stage: 'discovered', email: 'mia@miazhang.art', handle: '@miamakesart', outreachHistory: [], cashOffer: 400, aiDMs: ['Mia! Your dating content is next level. We built Wit Dating with AI that understands compatibility. Would love to see what you\'d create with it!', 'Hey Mia, your dating content always blow up. Wit Dating has AI message generation features that would make amazing content. Interested?', 'Hi Mia — Wit Dating AI + your creativity = viral content. Free premium + sponsorship for a dating challenge video?'] },
  { id: '10', name: 'Jake Wilson', initials: 'JW', color: COLORS[9], platform: 'Instagram', followers: '42K', followersNum: 42000, engagement: '7.1%', niche: ['Dating Coach', 'Urban'], stage: 'deal', email: 'jake@jakewilson.co', handle: '@jakesdatingcoach', outreachHistory: ['Jan 12 — DM sent', 'Jan 13 — Responded', 'Jan 16 — Call scheduled', 'Jan 18 — Deal: barter only (lifetime premium)'], cashOffer: 0, aiDMs: ['Jake! Your dating coach content is incredible. We built AI message writing that works for everyone. Would love to give you lifetime premium for a post!', 'Hey Jake, one-tap smart message writing — that\'s Wit Dating. Perfect for your style. Free lifetime premium for a review post?', 'Hi Jake — Wit Dating here. AI message writing for real connections. Barter deal: lifetime premium for an honest IG post?'] },
  { id: '11', name: 'Emma Davis', initials: 'ED', color: COLORS[10], platform: 'TikTok', followers: '520K', followersNum: 520000, engagement: '2.8%', niche: ['Dating Texting', 'Lifestyle'], stage: 'discovered', email: 'emma@emmadavis.co', handle: '@emmadating', outreachHistory: [], cashOffer: 1200, aiDMs: ['Emma! With 520K followers, you set dating trends. Wit Dating is the next trend — AI message generation in one tap. Premium collab opportunity!', 'Hey Emma, your content defines what\'s trending in dating. We\'d love to work together on Wit Dating launch content.', 'Hi Emma\'s team — Wit Dating (AI dating assistant) launching on Product Hunt. Emma would be an incredible launch partner. Details below.'] },
  { id: '12', name: 'Noah Thompson', initials: 'NT', color: COLORS[11], platform: 'YouTube', followers: '165K', followersNum: 165000, engagement: '4.0%', niche: ['Dating Texting', 'Gear'], stage: 'contacted', email: 'noah@noahthompson.co', handle: '@noahdatingtips', outreachHistory: ['Jan 20 — Email via management'], cashOffer: 450, aiDMs: ['Noah! Your dating tips videos are gold. We built Wit Dating — AI that finds your perfect match. Sponsored video opportunity?', 'Hey Noah, imagine AI that knows all the tips you teach. That\'s Wit Dating. Would love to sponsor a review/comparison video.', 'Hi Noah — Wit Dating (AI dating assistant) here. Your 165K dating audience is our dream demographic. Interested in a collab?'] },
  { id: '13', name: 'Zoe Clark', initials: 'ZC', color: COLORS[12], platform: 'Instagram', followers: '88K', followersNum: 88000, engagement: '5.3%', niche: ['Healthy Dating', 'Wellness'], stage: 'responded', email: 'zoe@zoeclark.co', handle: '@zoewellnessdating', outreachHistory: ['Jan 17 — DM sent', 'Jan 22 — Responded: "I\'d love to try it!"'], cashOffer: 200, aiDMs: ['Zoe! Your wellness dating style is exactly what Wit Dating\'s AI was trained on. Would love to send you early access + collab!', 'Hey Zoe, healthy dating + AI = match made in heaven. Wit Dating early access + paid post?', 'Hi Zoe — we built AI dating for intentional singles. Your aesthetic is perfect. Interested in early access?'] },
  { id: '14', name: 'Ryan Lee', initials: 'RL', color: COLORS[13], platform: 'TikTok', followers: '73K', followersNum: 73000, engagement: '5.5%', niche: ['Texting Life', 'Tips'], stage: 'results', email: 'ryan@ryanlee.dev', handle: '@ryandatinglife', outreachHistory: ['Jan 5 — DM sent', 'Jan 6 — Responded', 'Jan 8 — Deal closed: $150 + premium', 'Jan 15 — Video posted', 'Jan 22 — Results: 89K views, 2.1K clicks'], cashOffer: 150, aiDMs: ['Ryan! Dating life tips + AI message writing = perfect combo. Want to try Wit Dating and make a video?', 'Hey Ryan, we built the best AI dating assistant with AI. Your tips audience would love it. Collab?', 'Hi Ryan — Wit Dating AI editor. Dating life focused. Sponsorship + early access?'] },
  { id: '15', name: 'Chloe Wang', initials: 'CW', color: COLORS[14], platform: 'YouTube', followers: '230K', followersNum: 230000, engagement: '3.2%', niche: ['Lifestyle Apps', 'Reviews'], stage: 'negotiating', email: 'chloe@chloewang.com', handle: '@chloereviews', outreachHistory: ['Jan 14 — Email sent', 'Jan 16 — Management replied', 'Jan 20 — Rate card received: $600 for dedicated video'], cashOffer: 600, aiDMs: ['Chloe! Your creative app reviews are so thorough. We\'d love Wit Dating to be your next review — AI message writing done right.', 'Hey Chloe, your audience trusts your app picks. Wit Dating is launching and we\'d love a sponsored review. Details?', 'Hi Chloe\'s team — sponsorship inquiry for Wit Dating AI dating assistant review. Budget available for dedicated video.'] },
];
...
export default function InfluencersPage() {
  ...
  const suggestInfluencers = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch('/api/ai', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ task: 'suggest-influencers', appData, count: 8 }) });
