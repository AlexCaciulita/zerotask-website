...
// --- Mock Reviews ---
const REVIEWS = [
  { id: 1, rating: 1, text: "App crashes every time I try to generate a message. Completely unusable. I've tried reinstalling 3 times.", topics: ['Crashes'], date: '2026-02-10', author: 'frustrated_user22' },
  { id: 2, rating: 1, text: "Crashed on my iPhone 13 after the latest update. Lost all my saved conversation templates. Very disappointed.", topics: ['Crashes'], date: '2026-02-09', author: 'jmiller88' },
  { id: 3, rating: 1, text: "Force closes when pasting a conversation. Fix this ASAP!", topics: ['Crashes'], date: '2026-02-07', author: 'datingJenn' },
  { id: 4, rating: 2, text: "The app is okay but crashes frequently when generating replies on iPad.", topics: ['Crashes'], date: '2026-02-05', author: 'tabletUser' },
  { id: 5, rating: 1, text: "Keeps crashing mid-generation. I've lost great reply suggestions. Going back to writing my own.", topics: ['Crashes'], date: '2026-02-03', author: 'mike_dates' },
  ...
  { id: 7, rating: 1, text: "Crash crash crash. That's all this app does now. Used to be great for writing messages.", topics: ['Crashes'], date: '2026-01-28', author: 'loyalUser_gone' },
  { id: 8, rating: 2, text: "Random crashes when importing screenshots from Hinge. Lost my best openers.", topics: ['Crashes'], date: '2026-01-25', author: 'profileBrowser' },
  { id: 9, rating: 2, text: "$9.99/month for a message assistant? Are you kidding me? Way too expensive.", topics: ['Subscription Price'], date: '2026-02-11', author: 'budgetMinded' },
  { id: 10, rating: 1, text: "The free version only gives 3 messages a day. Everything useful is behind a paywall.", topics: ['Subscription Price'], date: '2026-02-08', author: 'freeTier_fan' },
  { id: 11, rating: 2, text: "I'd pay $4.99 but $9.99 is insane for a texting assistant. ChatGPT is cheaper!", topics: ['Subscription Price'], date: '2026-02-06', author: 'priceWatcher' },
  { id: 12, rating: 3, text: "Good app but the subscription price is hard to justify. Maybe offer a lifetime option?", topics: ['Subscription Price'], date: '2026-02-04', author: 'casual_dater' },
  ...
  { id: 14, rating: 2, text: "No way I'm paying monthly for basic reply suggestions. Make the opener generator free at least.", topics: ['Subscription Price'], date: '2026-01-29', author: 'messageLover' },
  { id: 15, rating: 3, text: "Decent app but the pricing model needs work. Too expensive for college students who need it most.", topics: ['Subscription Price'], date: '2026-01-26', author: 'student_single' },
  { id: 16, rating: 2, text: "Message quality is inconsistent. Sometimes the AI suggests generic stuff I'd never say.", topics: ['Message Quality'], date: '2026-02-10', author: 'qualityMatters' },
  { id: 17, rating: 3, text: "Love the concept but suggested replies don't always match my personality. Please fix!", topics: ['Message Quality'], date: '2026-02-08', author: 'prefsMatter' },
  { id: 18, rating: 2, text: "Why can't I customize the tone more? The messages sound too formal sometimes.", topics: ['Message Quality'], date: '2026-02-05', author: 'filterFan' },
  ...
  { id: 20, rating: 2, text: "The AI doesn't understand sarcasm or humor. My matches can tell it's AI-written.", topics: ['Message Quality'], date: '2026-01-30', author: 'prefIgnored' },
  { id: 21, rating: 3, text: "Support for more dating apps would be amazing. Currently only works well with Hinge and Tinder.", topics: ['Message Quality'], date: '2026-01-27', author: 'localDater' },
  { id: 22, rating: 2, text: "I can't figure out how to import a conversation screenshot. The UI is so confusing.", topics: ['UI Confusion'], date: '2026-02-11', author: 'newUser_lost' },
  { id: 23, rating: 3, text: "Too many menus and options. It takes forever to get a simple reply suggestion.", topics: ['UI Confusion'], date: '2026-02-09', author: 'simpleUI_please' },
  { id: 24, rating: 2, text: "Where is the tone selector? I've been looking for 10 minutes.", topics: ['UI Confusion'], date: '2026-02-06', author: 'unmatchWhere' },
  { id: 25, rating: 3, text: "The copy/paste workflow is clunky. I keep accidentally losing the generated message.", topics: ['UI Confusion'], date: '2026-02-03', author: 'accidentalPass' },
  { id: 26, rating: 3, text: "UI needs a redesign. It's cluttered and overwhelming for a simple message helper.", topics: ['UI Confusion'], date: '2026-01-31', author: 'beginnerDater' },
  { id: 27, rating: 2, text: "Settings are buried 5 levels deep. Why is the writing style preference hidden in advanced?", topics: ['UI Confusion'], date: '2026-01-28', author: 'settingsHunter' },
  { id: 28, rating: 5, text: "Best dating message assistant I've ever used! My response rate on Hinge went from 15% to 70%.", topics: ['Love It'], date: '2026-02-12', author: 'happy_dater' },
  { id: 29, rating: 5, text: "This app is AMAZING. I used to spend 20 min writing one Hinge message. Now it takes 30 seconds.", topics: ['Love It'], date: '2026-02-11', author: 'convertedUser' },
  { id: 30, rating: 5, text: "Used Wit to write my Tinder opener and got a date the same night. This is the future!", topics: ['Love It'], date: '2026-02-10', author: 'oneSwipeFan' },
  { id: 31, rating: 4, text: "Really solid app. The conversation starters are way better than anything I'd come up with.", topics: ['Love It'], date: '2026-02-09', author: 'convoStarter' },
  { id: 32, rating: 5, text: "I'm an introvert and this app makes texting on dating apps feel so much easier. Worth every penny.", topics: ['Love It'], date: '2026-02-08', author: 'introvert_anna' },
  { id: 33, rating: 4, text: "Love the AI suggestions! They sound natural, not like a robot wrote them.", topics: ['Love It'], date: '2026-02-07', author: 'naturalMatch' },
  { id: 34, rating: 5, text: "Finally an app that helps me actually have good conversations on Bumble. No more getting ghosted!", topics: ['Love It'], date: '2026-02-06', author: 'realDates' },
  { id: 35, rating: 4, text: "Great app overall. The icebreaker suggestions are a game-changer for Hinge.", topics: ['Love It'], date: '2026-02-04', author: 'icebreakerFan' },
  { id: 36, rating: 5, text: "My response rate went from 10% to 80% in two weeks using Wit. Can't recommend it enough!", topics: ['Love It'], date: '2026-02-02', author: 'successStory' },
  { id: 37, rating: 4, text: "Solid 4 stars. Would be 5 if message tone was more consistent. AI reply quality is fantastic.", topics: ['Love It', 'Message Quality'], date: '2026-01-31', author: 'almostPerfect' },
  { id: 38, rating: 5, text: "Recommended to all my friends who struggle with dating app conversations! The AI suggestions are magic.", topics: ['Love It'], date: '2026-01-29', author: 'wordOfMouth' },
  { id: 39, rating: 4, text: "Very impressed with how it adapts to my texting style. Messages actually sound like me.", topics: ['Love It'], date: '2026-01-27', author: 'quizFan' },
  { id: 40, rating: 5, text: "This is what dating app messaging should be. Smart, quick, and natural. 10/10.", topics: ['Love It'], date: '2026-01-25', author: 'simplicity_wins' },
  { id: 41, rating: 3, text: "Decent app. Crashes sometimes and UI could be better, but the message suggestions are solid.", topics: ['Crashes', 'UI Confusion'], date: '2026-02-10', author: 'mixed_feelings' },
  { id: 42, rating: 3, text: "Good concept, mediocre execution. Fix the bugs and you'll have a 5-star message assistant.", topics: ['Crashes'], date: '2026-02-07', author: 'potentialFan' },
  { id: 43, rating: 1, text: "Subscription expired and I lost access to ALL my saved message templates. Terrible!", topics: ['Subscription Price'], date: '2026-02-04', author: 'matchLoss' },
  { id: 44, rating: 4, text: "Really good but please add support for Bumble video chat openers. Would make it perfect.", topics: ['Love It'], date: '2026-02-01', author: 'videoWanter' },
  ...
  { id: 46, rating: 2, text: "The daily message limit on free tier is way too restrictive. 3 messages is nothing.", topics: ['Subscription Price'], date: '2026-01-26', author: 'limitHater' },
  { id: 47, rating: 4, text: "Great app! Just wish there was a keyboard extension for quick access while texting.", topics: ['Love It'], date: '2026-01-24', author: 'widgetWanter' },
  { id: 48, rating: 3, text: "Reply suggestions are good but I want more control over tone and length.", topics: ['UI Confusion'], date: '2026-01-22', author: 'filterControl' },
  ...
  { id: 50, rating: 5, text: "Updated review: after the patch, it's perfect. Best dating message assistant, period.", topics: ['Love It'], date: '2026-01-18', author: 'updatedReview' },
];
...
const AI_RESPONSES: Record<number, string> = {
  1: "Hi there, we're so sorry about the crashes you're experiencing! Our team is actively working on a fix that will be in our next update (v3.2.1). In the meantime, please try clearing the app cache in Settings > Storage. We'd love to make this right — reach out to support@witdating.app.",
  2: "We sincerely apologize for the crashes after the update. We've identified the issue and a hotfix is rolling out this week. We hate that you lost your conversations — please contact us and we'll help recover what we can.",
  ...
  10: "We hear you! We're working on expanding the free tier to include more features. Our goal is to make Wit Dating accessible to everyone while sustaining development.",
  16: "Thank you for flagging this! We've identified the tone consistency issue and improvements to our AI are coming in the next update. You deserve better message suggestions!",
...
const FEATURE_REQUESTS = [
  ...
  { feature: 'Voice message script generator', mentions: 12, priority: 'Medium' },
  { feature: 'Lifetime purchase option', mentions: 28, priority: 'High' },
  { feature: 'Bumble video chat openers', mentions: 9, priority: 'Low' },
  { feature: 'Cloud sync for saved templates', mentions: 15, priority: 'High' },
  { feature: 'Group chat message helper', mentions: 22, priority: 'High' },
  { feature: 'Screenshot import from more apps', mentions: 7, priority: 'Low' },
];
...
export default function ReviewsPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await fetch('/api/scrape/reviews', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ appId }) });
  ...
  const fetchRealReviews = useCallback(async () => {
    ...
    try {
      ...
      if (!appId) { appId = prompt('Enter App Store ID (e.g. 595287172 for Hinge):'); if (!appId) { setFetchingReviews(false); return; } }
      const res = await fetch('/api/scrape/reviews', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ appId }) });
  ...
  const analyzeWithAI = useCallback(async () => {
    ...
    try {
      const res = await fetch('/api/ai', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ task: 'analyze-reviews', reviews: allReviews.map(r => ({ text: r.text, rating: r.rating, id: String(r.id) })), brandVoice: getBrandVoice() }) });
  ...
  const generateResponse = useCallback(async (reviewId: number) => {
    ...
    try {
      ...
      const res = await fetch('/api/ai', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ task: 'freeform', tier: 'fast', prompt: `Write a professional, empathetic response to this negative app review. Be specific about the issue, show empathy, and offer a solution. Keep it under 200 words.\n\nReview (${review.rating}★): "${review.text}"`, brandVoice: getBrandVoice() }) });
      const data = await res.json(); if (!res.ok) throw new Error(data.error || 'AI request failed');
