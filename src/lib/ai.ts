...
- Current description: ${appData.description || 'AI dating assistant that helps write witty, personalized messages for Hinge, Tinder, and Bumble'}
- Current keywords: ${appData.keywords?.join(', ') || 'dating assistant, message writer, dating app helper, opener generator, hinge helper, tinder messages, bumble replies, conversation starter'}
...
Here's an example of a great App Store listing for a dating assistant app:
{
  "title": "Wit - AI Dating Assistant",
  "subtitle": "Write Better Dating Messages",
  "description": "Stop staring at a blank screen. Wit crafts witty, personalized openers and replies for Hinge, Tinder, and Bumble — so you get more matches and better conversations.\\n\\n• AI-powered message suggestions tailored to their profile\\n• Works with Hinge, Tinder, Bumble & more\\n• Conversation coaching to keep the spark alive",
  "keywords": "dating assistant,message writer,dating app helper,opener generator,hinge helper,tinder messages,bumble replies,dating coach,conversation starter,rizz"
}

App details:
Name: ${appData.name}
Category: ${appData.category}
Current description: ${appData.description || 'An AI dating assistant that helps write better messages on dating apps'}`;
...
Examples that went viral for dating apps:
- "My friend said she's terrible at texting guys so I showed her what AI wrote for her Hinge match" (312K views)
- "My roommate hasn't gotten a single reply on Bumble so I let AI rewrite his openers" (198K views)
- "My sister said dating apps are dead so I showed her my AI-written conversation that got a date in 5 messages" (245K views)

Rules:
- Every hook MUST have another person (friend, roommate, sister, coworker, date, crush)
- Every hook MUST have conflict or doubt about dating/texting
- Every hook must be under 100 characters
- Make them feel like real human stories, not ads
- Focus on dating struggles: bad openers, no replies, awkward convos, ghosting
...
Avoid:
- Single generic words like "dating" or "chat"
- Keywords dominated by big players (Tinder, Bumble, Hinge themselves)
